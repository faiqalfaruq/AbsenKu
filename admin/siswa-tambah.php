...
<body style="background-image: url('../assets/img/this_background.png'); background-size: cover; background-position: center;">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        // Cek apakah NIS sudah terdaftar di salah satu tabel
        ...
        if ($cek || $cekAkun) {
            ...
            if ($insertSiswa && $insertAkun) {
                echo "<script>alert('Akun berhasil ditambahkan!.'); window.location='siswa.php';</script>";
            } else {
            ...
            <div class="col-md-6">
                <div class="card border border-dark shadow">
                    <div class="card-body p-4">
                        <h3 class="text-center mb-4">Tambah Akun Siswa</h3>
